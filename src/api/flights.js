...
export const getFlightShares    = (id)           => client.get(`/api/flights/${id}/shares`).then(r => r.data)
export const updateFlightShares = (id, agencyIds) => client.put(`/api/flights/${id}/shares`, agencyIds)
