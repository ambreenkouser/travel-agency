...
export default function PackageBookingPage() {
  ...
  const seatsOk = bookableType !== 'umrah' || !selectedAirline ||
    selectedAirline.availableSeats >= totalPassengers
  ...
  const typeLabel = bookableType === 'hajj' ? 'Hajj' : 'Umrah'
        ...
        <Card className="p-5">
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div className="space-y-1">
              ...
              {bookableType === 'hajj' && pkg.quotaTotal != null && (
