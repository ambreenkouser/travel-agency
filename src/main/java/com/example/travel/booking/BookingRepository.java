...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findByBookedByUserIdInOrderByCreatedAtDesc(Collection<Long> userIds);
    ...
    List<Booking> findByStatusAndBookedByUserIdInOrderByCreatedAtDesc(BookingStatus status, Collection<Long> userIds);
